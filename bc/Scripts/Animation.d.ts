 ...
 */
declare function AnimationGetDynamicDataName(C: Character, Asset?: Asset): AnimationDataKey;
/**
 ...
 */
declare function AnimationPersistentDataGet(C: Character, Asset: Asset): AnimationPersistentData;
/**
 ...
 */
declare function AnimationGroupGet(C: Character, Name: AnimationDataKey): {
    Subscriptions: AnimationDataKey[];
};
/**
