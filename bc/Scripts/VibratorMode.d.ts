 ...
 * @namespace
 */
declare const VibratorModeStateUpdate: {
    /**
     ...
     */
    Default(C: Character, arousal: number, timeSinceLastChange: number, oldIntensity: VibratorIntensity, transitionsFromDefault: readonly VibratorModeState[]): StateAndIntensity;
    /**
     ...
     * @returns {StateAndIntensity} - The updated state and intensity of the vibrator
     */
    Deny(C: Character, arousal: number, timeSinceLastChange: number, oldIntensity: VibratorIntensity): StateAndIntensity;
    /**
     ...
     * @returns {StateAndIntensity} - The updated state and intensity of the vibrator
     */
    Orgasm(C: Character, arousal: number, timeSinceLastChange: number, oldIntensity: VibratorIntensity): StateAndIntensity;
    /**
     ...
     * @returns {StateAndIntensity} - The updated state and intensity of the vibrator
     */
    Rest(C: Character, arousal: number, timeSinceLastChange: number, oldIntensity: VibratorIntensity): StateAndIntensity;
};
/**
