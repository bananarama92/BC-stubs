declare namespace Toasts {
   ...
   */
  type CloseReason = 'timeout' | 'manual' | 'click' | 'external' | (string & {});
  ...
  interface Options {
    ...
    closable?: boolean;
    /** Whether the toast can be dismissed externally. See {@link ToastManager.dismissAll} or {@link ToastManager.dismissByType}. */
    externallyDismissible?: boolean;
